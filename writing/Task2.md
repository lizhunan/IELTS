...
In my opinion, providing free public transport can not to solve traffic congestions. In the frist place, developing the road construction is better way than development of  free public transport. Due to developmemt of road in cities such as building more roads, widening the road, there are many roads could be use. Therefore, main-road's stree could be relieved efficiently, which leads  to reduce traffic jam problem. In the second place, the number of vehicle could be reduced in road because to encourage people select low carban transport such as cycling, jogging and walking, which contribute to the fact that the traffic congestions could be solved.
